...
<head>
  <link rel="_site/assets/stylesheet.css">
</head>
...
<h2>Planning, Action, Execution</h2>
  <p>Today we will be talking about a number of things, mainly breaking into the tech industry itself. We'll also be going over roadmaps, and where to fit your creative needs. Today, I will talk about various topics and careers - we can see what aligns with you!</p>
  <h2>Web Development</h2>
  <p>What we'll cover: Where to start, launguages, salaries, and occupations.</p>
  <h2>Cyber Security</h2>
  <p>What we'll cover: Where to start, languages, salaries, and occupations</p>
</div>
